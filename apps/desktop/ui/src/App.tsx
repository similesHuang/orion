...
export function App(): ReactElement {
  ...
  const orionTheme = useMemo(() => ({
    ...
    components: {
      Button: {
        colorPrimaryBg: themeMode === 'dark' ? 'rgba(56,139,253,0.15)' : 'rgba(37,99,235,0.10)',
        colorPrimaryText: themeMode === 'dark' ? '#58a6ff' : '#2563eb',
      },
      Input: {
        activeBorderColor: 'transparent',
        activeShadow: '0 0 0 0 transparent',
        hoverBorderColor: themeMode === 'dark' ? '#484f58' : '#d1d5db',
      },
    },
  }), [themeMode])
